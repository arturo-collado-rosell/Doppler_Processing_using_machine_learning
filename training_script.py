...
H = RadarNet.model_compile_and_train(model, X_train, y_train_cat_vel, y_train_cat_s_w, y_train_cat_csr, X_test, y_test_cat_vel, y_test_cat_s_w, y_test_cat_csr)

    

#Ploting the training and validation metrics
# radar_net.plot_training(H, 'plot_training')